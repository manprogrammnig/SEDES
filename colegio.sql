...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-09-2024 a las 00:18:24
...
CREATE PROCEDURE `SP_CARGAR_HORA_ID_AULA` (IN `ID` INT)   SELECT
	horas_aula.id_hora, 
...
WHERE horas_aula.id_aula =ID and `año_escolar`=(SELECT(YEAR(NOW())))$$
...
CREATE PROCEDURE `SP_CARGAR_SELECT_HORAS` (IN `ID` INT)   SELECT
	horas_aula.id_hora, 
...
FROM
	horas_aula
WHERE
	horas_aula.id_aula=ID AND horas_aula.estado='ACTIVO'$$
...
CREATE PROCEDURE `SP_LISTAR_ALUMNOS_TOTALES` (IN `MES` VARCHAR(18), IN `ID_AULA` INT)   BEGIN
    SELECT
        alumnos.Id_alumno,
        alumnos.alum_dni AS DNI,
        CONCAT_WS(' ', alumnos.alum_nombre, alumnos.alum_apepat, alumnos.alum_apemat) AS Estudiante,
...
CREATE PROCEDURE `SP_LISTAR_ALUMNOS_TOTALES_DIA` (IN `MES` VARCHAR(18), IN `ID_AULA` INT)   BEGIN
    SELECT
        alumnos.Id_alumno,
        alumnos.alum_dni AS DNI,
        CONCAT_WS(' ', alumnos.alum_nombre, alumnos.alum_apepat, alumnos.alum_apemat) AS Estudiante,
...
CREATE PROCEDURE `SP_LISTAR_EXAMENES` ()   SELECT
	...
	examen.created_at,
		date_format(examen.created_at, "%d-%m-%Y - %H:%i:%s") AS fecha_publicacion, 
...
CREATE PROCEDURE `SP_REGISTRAR_ASIGNATURA_DOCENTE` (IN `IDDOCENTE` INT)   BEGIN 

DECLARE ULTI INT;

INSERT INTO asignatura_docente(Id_docente,Total_cursos,created_at,updated_at)VALUES
(IDDOCENTE,'',NOW(),'');
...
(4, '59222662', 'ESTEFANY', 'COAQUIRA', 'CHIPANA', 'FEMENINO', '2018-02-15', 6, '922662262', 'JR. HUANCAVELICA N° 887', 'SI', 'ANTIGUO', 'controller/alumnos/fotos/IMG6-7-2024-11-246.PNG', '2024-07-06 11:12:03', '2024-07-06 11:12:19'),
...
(7, '52220200', 'JOSE LUIS', 'JIMENEZ', 'DAVILA', 'MASCULINO', '2010-06-14', 14, '929292662', 'AV. NUÑEZ N° 232', 'SI', 'ANTIGUO', 'controller/alumnos/fotos/IMG11-9-2024-16-807.gif', '2024-09-10 14:10:49', '2024-09-11 16:52:11');
...
(10, 'SOCIALES', 18, '', 'CON DOCENTE', '2024-09-04', '0000-00-00 00:00:00'),
(11, 'ANATOMIA', 18, 'CORRECTO', 'CON DOCENTE', '2024-09-04', '2024-09-08 16:48:34'),
(12, 'BIOLOGIA', 18, '', 'CON DOCENTE', '2024-09-04', '0000-00-00 00:00:00'),
(13, 'ALGEBRA', 18, '', 'CON DOCENTE', '2024-09-04', '0000-00-00 00:00:00'),
(14, 'EDUCACION FISICA', 18, '', 'CON DOCENTE', '2024-09-04', '0000-00-00 00:00:00'),
(15, 'GEOMETRIA', 18, '', 'CON DOCENTE', '2024-09-04', '0000-00-00 00:00:00'),
(16, 'COMUNICACION', 18, '', 'CON DOCENTE', '2024-09-04', '0000-00-00 00:00:00'),
(17, 'FISICA', 18, '', 'CON DOCENTE', '2024-09-04', '0000-00-00 00:00:00'),
(18, 'DPCC', 18, '', 'CON DOCENTE', '2024-09-04', '0000-00-00 00:00:00'),
(19, 'QUIMICA', 18, '', 'CON DOCENTE', '2024-09-04', '0000-00-00 00:00:00'),
(20, 'RELIGION', 18, '', 'CON DOCENTE', '2024-09-04', '0000-00-00 00:00:00'),
(21, 'TUTORIA', 18, '', 'CON DOCENTE', '2024-09-04', '0000-00-00 00:00:00'),
(22, 'INGLES', 18, '', 'CON DOCENTE', '2024-09-04', '0000-00-00 00:00:00'),
(23, 'RAZONAMIENTO MATEMATICO', 18, '', 'CON DOCENTE', '2024-09-04', '0000-00-00 00:00:00'),
(24, 'ARITMETICA', 18, '', 'CON DOCENTE', '2024-09-04', '0000-00-00 00:00:00'),
(25, 'COMPUTACION', 18, '', 'CON DOCENTE', '2024-09-04', '0000-00-00 00:00:00'),
(26, 'TRIGONOMETRIA', 18, '', 'CON DOCENTE', '2024-09-04', '0000-00-00 00:00:00'),
(27, 'ARTE', 18, '', 'CON DOCENTE', '2024-09-04', '0000-00-00 00:00:00'),
(28, 'RECREO', 18, '', 'CON DOCENTE', '2024-09-04', '2024-09-04 17:09:42'),
...
INSERT INTO `asignatura_docente` (`Id_asigdocente`, `Id_docente`, `Total_cursos`, `created_at`, `updated_at`) VALUES
(27, 1, 1, '2024-08-01', '0000-00-00 00:00:00.000000'),
(30, 1, 4, '2024-08-01', '0000-00-00 00:00:00.000000'),
(31, 15, 2, '2024-08-02', '0000-00-00 00:00:00.000000'),
(33, 11, 19, '2024-09-04', '0000-00-00 00:00:00.000000'),
(34, 6, 2, '2024-09-10', '0000-00-00 00:00:00.000000'),
(35, 10, 2, '2024-09-10', '0000-00-00 00:00:00.000000');
...
(6, 1, 9, 'PSICOLOGIA', 'SESION 2 DE TERAPIA', '', '', '2024-08-02 16:28:11', '0000-00-00 00:00:00'),
...
(3, 'GENERAL', 4, 'REUNION PADRE DE FAMILIA 8 PM VIERNES 23', 'SE CITA A TODO LOS PADRES DE FAMILIA23', 'controller/comunicados/fotos/IMG4-8-2024-13-208.jpeg', 'INACTIVO', 9, '2024-08-04', '2024-08-31 17:53:20'),
...
(63, 31, 29, '2024-09-08', '2024-09-08 17:24:45.000000'),
...
(22, 'T0000001', 1, '', 0, '', 'ENVIADO', '0000-00-00 00:00:00', '2024-08-07', '0000-00-00 00:00:00'),
(23, 'T0000001', 14, '', 0, '', 'PENDIENTE', '0000-00-00 00:00:00', '2024-08-07', '0000-00-00 00:00:00'),
(24, 'T0000001', 25, '', 0, '', 'PENDIENTE', '0000-00-00 00:00:00', '2024-08-07', '0000-00-00 00:00:00'),
(25, 'T0000002', 1, '', 0, '', 'PENDIENTE', '0000-00-00 00:00:00', '2024-08-07', '0000-00-00 00:00:00'),
(26, 'T0000002', 14, '', 0, '', 'PENDIENTE', '0000-00-00 00:00:00', '2024-08-07', '0000-00-00 00:00:00'),
(27, 'T0000002', 25, '', 0, '', 'PENDIENTE', '0000-00-00 00:00:00', '2024-08-07', '0000-00-00 00:00:00'),
(28, 'T0000003', 28, '', 0, '', 'PENDIENTE', '0000-00-00 00:00:00', '2024-09-10', '0000-00-00 00:00:00'),
(29, 'T0000003', 29, '', 0, '', 'PENDIENTE', '0000-00-00 00:00:00', '2024-09-10', '0000-00-00 00:00:00'),
(30, 'T0000004', 28, '', 0, '', 'PENDIENTE', '0000-00-00 00:00:00', '2024-09-10', '0000-00-00 00:00:00'),
(31, 'T0000004', 29, '', 0, '', 'PENDIENTE', '0000-00-00 00:00:00', '2024-09-10', '0000-00-00 00:00:00'),
(32, 'T0000005', 28, '', 0, '', 'PENDIENTE', '0000-00-00 00:00:00', '2024-09-11', '0000-00-00 00:00:00'),
(33, 'T0000005', 29, '', 0, '', 'PENDIENTE', '0000-00-00 00:00:00', '2024-09-11', '0000-00-00 00:00:00');
...
(10, '56151515', 'JOAQUIN', 'PEÑA LOZANO', 5, 'FEMENINO', '1996-01-15', '959296262', '922654785', 'JR. PUNO N° 448', 'ACTIVO', 'controller/docentes/fotos/IMG6-7-2024-15-665.webp', 19, '2024-07-06', '2024-07-06 15:08:59'),
...
(1, 'SEDES SAPIENTIAE', 'contacto@sedessapientiaeabancay.edu.pe\r\ncontacto@sedessapientiaeabancay.edu.pe\r\ncontacto@sedessapientiaeabancay.edu.pe\r\ncontacto@sedessapientiaeabancay.edu.pe\r\ncontacto@sedessapientiaeabancay.edu.pe\r\ncontacto@sedessapientiaeabancay.edu.pe\r\ncontacto@s', '3434', '946 701 820', 'Jr Mayta Capac S/N Abancay, Abancay Apurímac, Abancay, Peru', 'diresa.png', NULL, NULL);
...
('E0000001', 20, 'CALIGRAFIA', 'SE REALIZARA EL EXAMEN EN BASE 20', '2024-08-14 17:38:46', 'PENDIENTE', '2024-08-11', '2024-08-11 13:09:04', 1),
('E0000002', 22, 'SUMA Y RESTA', 'SE REALIZARA EL EXAMEN EN 1 HORA', '2024-08-11 12:17:43', 'REALIZADO', '2024-08-11', '0000-00-00 00:00:00', 2),
('E0000003', 24, 'ORTOGRAFÍA', 'SE DESARROLLARA EL EXAMEN PRACTICAR', '2024-08-16 11:00:00', 'PENDIENTE', '2024-08-11', '0000-00-00 00:00:00', 3);
...
(15, 3, 1, 5, 100.00, 250.00, 160.00, 'AURORA', 'ABANCAY', 'APURIMAC', 48, '2024-07-20', '2024-07-22 16:22:19'),
(25, 4, 2, 5, 100.00, 250.00, 160.00, 'ROSARIO', 'ABANCAY', 'APURIMAC', 49, '2024-07-20', '2024-07-22 16:26:41'),
(26, 4, 1, 6, 0.00, 0.00, 170.00, '', '', '', 49, '2024-07-20', '2024-07-22 16:30:54'),
(27, 5, 2, 6, 250.00, 100.00, 160.00, '', '', '', 51, '2024-08-03', '2024-08-03 11:55:40'),
(28, 6, 2, 15, 100.00, 50.00, 250.00, 'INDIVISA', 'ABANCAY', 'APURIMAC', 52, '2024-09-10', '2024-09-10 14:32:20'),
...
(127, 1, 14, 1, 'AD/20', '', NULL, '2024-09-01 18:25:33'),
(128, 1, 14, 8, 'AD/20', '', NULL, '2024-09-01 18:25:33'),
(129, 1, 14, 18, 'AD/20', '', NULL, '2024-09-01 18:25:33'),
(130, 1, 14, 19, '12.00', '', NULL, '2024-09-01 18:25:33'),
(131, 1, 14, 20, '11.00', '', NULL, '2024-09-01 18:25:33'),
(132, 1, 14, 21, '12.00', '', NULL, '2024-09-01 18:25:33'),
...
(181, 28, 14, 36, 'A/15', '', '2024-09-10', NULL),
(182, 28, 14, 37, 'A/15', '', '2024-09-10', NULL),
(183, 28, 14, 38, 'A/15', '', '2024-09-10', NULL),
(184, 28, 14, 39, 'A/15', '', '2024-09-10', NULL),
(185, 28, 14, 40, 'A/15', '', '2024-09-10', NULL),
(186, 28, 14, 41, 'A/15', '', '2024-09-10', NULL),
(187, 28, 14, 29, 'A/15', '', '2024-09-11', NULL),
(188, 28, 14, 30, 'A/15', '', '2024-09-11', NULL),
(189, 28, 14, 31, 'A/14', '', '2024-09-11', NULL),
(190, 28, 14, 32, 'A/15', '', '2024-09-11', NULL),
(191, 28, 14, 33, 'AD/18', '', '2024-09-11', NULL),
(192, 28, 14, 34, 'AD/18', '', '2024-09-11', NULL),
(193, 28, 14, 35, 'AD/18', '', '2024-09-11', NULL);
...
(123, 1, 14, 'Asiste y participa activamente en actividades y reuniones del Aula', 'A', '2024-08-30', '2024-09-01 18:25:33'),
(124, 1, 14, 'Acude regularmente al colegio en el horario de atencion a padres de familia, para dialogar con los docentes sobre el rendimiento academico y la conducta de su hijo. (a)', 'A', '2024-08-30', '2024-09-01 18:25:33'),
(125, 1, 14, 'Cumple con las cuotas de pension.', 'A', '2024-08-30', '2024-09-01 18:25:33'),
...
INSERT INTO `pago_pensiones` (`id_pago_pension`, `id_matri`, `concepto`, `id_pension`, `fecha_pago`, `sub_total`, `created_at`, `updated_at`) VALUES
(1, 14, 'ADMISION', NULL, '2024-07-20', 100.00, '2024-07-20', '2024-07-20 10:56:48'),
(2, 14, 'ALUMNO NUEVO', NULL, '2024-07-20', 250.00, '2024-07-20', '2024-07-20 10:56:48'),
(3, 14, 'MATRICULA', NULL, '2024-07-22', 160.00, '2024-07-20', '2024-07-20 10:56:48'),
(4, 15, 'ADMISION', NULL, '2024-07-20', 100.00, '2024-07-20', '2024-07-20 10:58:07'),
(5, 15, 'ALUMNO NUEVO', NULL, '2024-07-20', 250.00, '2024-07-20', '2024-07-20 10:58:07'),
(6, 15, 'MATRICULA', NULL, '2024-07-20', 160.00, '2024-07-20', '2024-07-20 10:58:07'),
(10, 8, 'ADMISION', NULL, '2024-07-20', 0.00, '2024-07-20', '2024-07-20 12:33:02'),
(11, 8, 'ALUMNO NUEVO', NULL, '2024-07-20', 0.00, '2024-07-20', '2024-07-20 12:33:02'),
(12, 8, 'MATRICULA', NULL, '2024-07-20', 160.00, '2024-07-20', '2024-07-20 12:33:02'),
(31, 25, 'ADMISION', NULL, '2024-07-20', 100.00, '2024-07-20', '2024-07-20 13:09:06'),
(32, 25, 'ALUMNO NUEVO', NULL, '2024-07-20', 250.00, '2024-07-20', '2024-07-20 13:09:06'),
(33, 25, 'MATRICULA', NULL, '2024-07-20', 160.00, '2024-07-20', '2024-07-20 13:09:06'),
(34, 26, 'ADMISION', NULL, '2024-07-20', 0.00, '2024-07-20', '2024-07-20 13:12:04'),
(35, 26, 'ALUMNO NUEVO', NULL, '2024-07-20', 0.00, '2024-07-20', '2024-07-20 13:12:04'),
(36, 26, 'MATRICULA', NULL, '2024-07-20', 250.00, '2024-07-20', '2024-07-20 13:12:04'),
(53, 8, 'PENSION', 3, '2024-07-29', 250.00, '2024-07-29', '0000-00-00 00:00:00'),
(54, 8, 'PENSION', 4, '2024-07-29', 250.00, '2024-07-29', '0000-00-00 00:00:00'),
(55, 14, 'PENSION', 3, '2024-07-29', 250.00, '2024-07-29', '0000-00-00 00:00:00'),
(56, 8, 'PENSION', 5, '2024-07-29', 250.00, '2024-07-29', '0000-00-00 00:00:00'),
(57, 14, 'PENSION', 4, '2024-07-29', 250.00, '2024-07-29', '0000-00-00 00:00:00'),
(58, 8, 'PENSION', 6, '2024-07-29', 250.00, '2024-07-29', '0000-00-00 00:00:00'),
(59, 15, 'PENSION', 3, '2024-07-29', 250.00, '2024-07-29', '0000-00-00 00:00:00'),
(60, 15, 'PENSION', 4, '2024-07-29', 250.00, '2024-07-29', '0000-00-00 00:00:00'),
(61, 26, 'PENSION', 3, '2024-07-29', 250.00, '2024-07-29', '0000-00-00 00:00:00'),
(62, 15, 'PENSION', 5, '2024-07-29', 250.00, '2024-07-29', '0000-00-00 00:00:00'),
(63, 25, 'PENSION', 3, '2024-07-31', 250.00, '2024-07-31', '0000-00-00 00:00:00'),
(64, 26, 'PENSION', 4, '2024-08-02', 250.00, '2024-08-02', '0000-00-00 00:00:00'),
(65, 27, 'ADMISION', NULL, '2024-08-03', 250.00, '2024-08-03', '2024-08-03 11:55:40'),
(66, 27, 'ALUMNO NUEVO', NULL, '2024-08-03', 100.00, '2024-08-03', '2024-08-03 11:55:40'),
(67, 27, 'MATRICULA', NULL, '2024-08-03', 160.00, '2024-08-03', '2024-08-03 11:55:40'),
(68, 27, 'PENSION', 3, '2024-09-08', 250.00, '2024-09-08', '0000-00-00 00:00:00'),
(69, 28, 'ADMISION', NULL, '2024-09-10', 100.00, '2024-09-10', '2024-09-10 14:11:48'),
(70, 28, 'ALUMNO NUEVO', NULL, '2024-09-10', 50.00, '2024-09-10', '2024-09-10 14:11:48'),
(71, 28, 'MATRICULA', NULL, '2024-09-10', 250.00, '2024-09-10', '2024-09-10 14:11:48'),
(72, 29, 'ADMISION', NULL, '2024-09-10', 100.00, '2024-09-10', '2024-09-10 14:12:44'),
(73, 29, 'ALUMNO NUEVO', NULL, '2024-09-10', 50.00, '2024-09-10', '2024-09-10 14:12:44'),
(74, 29, 'MATRICULA', NULL, '2024-09-10', 250.00, '2024-09-10', '2024-09-10 14:12:44');
...
('T0000001', 20, 'CALIGRAFIA2', 'DESARROLLAR EL EJERCICIO DE CALIGRAFIA2', '2024-07-09 17:38:46', 'controller/tareas/documentos/1723070700', 'PENDIENTE', '2024-08-07', '2024-08-07 17:45:00', 1),
('T0000002', 22, 'SUMA Y RESTA', 'REALIZAR LA SUMA Y RESTA', '2024-08-08 17:47:19', 'controller/tareas/documentos/1723070869', 'PENDIENTE', '2024-08-07', '0000-00-00 00:00:00', 2),
('T0000003', 67, 'TABLA PERIODICA2', 'DIBUJAR LA TABLA PERIODICA2', '2024-09-12 16:40:49', 'controller/tareas/documentos/1726005633', 'PENDIENTE', '2024-09-10', '2024-09-10 17:00:33', 3),
('T0000004', 67, 'EJERCICIOS A RESOLVER', 'RESOLVER LOS EJERCICIOS QUE SE DEJO COMO TAREA', '2024-09-13 16:44:38', 'controller/tareas/documentos/1726005454', 'PENDIENTE', '2024-09-10', '2024-09-11 15:09:23', 4),
('T0000005', 64, 'FUNCIONES', 'DESARROLLAR LAS FUNCIONES QUE SE MUESTRAN EN PANTALLA', '2024-09-12 14:57:58', 'controller/tareas/documentos/1726084715', 'PENDIENTE', '2024-09-11', '0000-00-00 00:00:00', 5);
...
(34, 'jose2024', '$2y$12$p9laoSBws/oUR0yPfYmDaO1XpBZV37.qfv2Uzns2iaUE3lqIh0cQq', 'jose2024@utea.edu.pe', 'ACTIVO', 1, 1, '2024-07-16 16:30:37', NULL),
...
(49, 'ESTEFANY', '$2y$12$4CADe0JGfGfAFDzNMnzWzemaLbbGZbUHZx1lF81sIdVn59/18URgy', 'ESTEFANY12@GMAIL.COM', 'ACTIVO', 1, 1, '2024-07-20 13:09:06', '2024-07-20 13:09:06'),
...
(52, 'YESSENIA', '$2y$12$eUTaDW5fFXdazMyt81hhlezqBVomI1QWhUWDhHhy/9jIwnRxCMWc.', 'YESSENIA2024@GMAIL.COM', 'ACTIVO', 1, 1, '2024-09-10 14:11:48', '2024-09-10 14:11:48'),
...
--
ALTER TABLE `asignatura_docente`
  MODIFY `Id_asigdocente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `detalle_asignatura_docente`
  MODIFY `Id_detalle_asig_docente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;

--
-- AUTO_INCREMENT de la tabla `detalle_tarea`
--
ALTER TABLE `detalle_tarea`
  MODIFY `id_detalle_tarea` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `horarios`
  MODIFY `id_horario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;

--
-- AUTO_INCREMENT de la tabla `horas_aula`
--
ALTER TABLE `horas_aula`
  MODIFY `id_hora` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `notas`
  MODIFY `id_nota_bole` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=194;

--
-- AUTO_INCREMENT de la tabla `notas_padre`
--
ALTER TABLE `notas_padre`
  MODIFY `id_nota_papa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=153;

--
-- AUTO_INCREMENT de la tabla `padres`
--
ALTER TABLE `padres`
  MODIFY `id_papas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `pago_pensiones`
--
ALTER TABLE `pago_pensiones`
  MODIFY `id_pago_pension` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;

--
-- AUTO_INCREMENT de la tabla `pensiones`
--
ALTER TABLE `pensiones`
  MODIFY `id_pensiones` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `usuario`
  MODIFY `usu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
...
--
ALTER TABLE `asistencia`
  ADD CONSTRAINT `fk_matirrr` FOREIGN KEY (`id_matricula`) REFERENCES `matricula` (`id_matricula`) ON DELETE NO ACTION ON UPDATE CASCADE;
...
--
ALTER TABLE `detalle_tarea`
  ADD CONSTRAINT `fk_matriculado` FOREIGN KEY (`id_matriculado`) REFERENCES `matricula` (`id_matricula`) ON UPDATE CASCADE,
...
ALTER TABLE `notas`
  ...
  ADD CONSTRAINT `id_matri` FOREIGN KEY (`id_matricula`) REFERENCES `matricula` (`id_matricula`) ON DELETE NO ACTION ON UPDATE CASCADE;
...
--
ALTER TABLE `pago_pensiones`
  ADD CONSTRAINT `fk_matri` FOREIGN KEY (`id_matri`) REFERENCES `matricula` (`id_matricula`) ON UPDATE CASCADE,
