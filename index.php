  ...
  <div class="card">
    ...
    <img src="img/logo1.png" alt="" width="100%" height="100%">		      	
      <p class="login-box-msg" style="font-family:Arial black; font-size:15px; color:black"><b>DATOS DEL USUARIO</b></p>
        ...
        <div class="col-12">
        <p class="mb-1">
        <a href="#"><i class="fas fa-user-tie" style="color:green"></i>   <b> -> Interactuar como docente</b></a>
        </p>
        <p class="mb-1">
        <a href="#"><i class="fas fa-users" style="color:green"></i>   <b> -> Interactuar como padre de familia</b></a>
        </p>
        </div>
